...
exports.GoParser = exports.PythonParser = exports.JSParser = void 0;
...
class JSParser {
    ...
    findFunctions(content, filePath, relativePath, entities) {
    ...
    findClasses(content, filePath, relativePath, entities) {
 ...
 */
function getParserForFile(filePath, basePath = '') {
    const language = (0, fileUtils_1.getFileLanguage)(filePath);
    switch (language) {
        case 'javascript':
        case 'typescript':
            return new JSParser();
